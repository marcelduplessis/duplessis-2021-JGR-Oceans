def process_slocum_data_L1(dat_glider):
    ...
    time_grid = gt.grid_data(dat_glider.dives, dat_glider.ctd_depth, dates.date2num(dat_glider.time), how='median', bins=np.arange(0, 1001, 1))
